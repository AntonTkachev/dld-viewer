...
COPY = {
    'ru': {
        ...
        'title_sales': 'Сделки в {name}{period_title}: {n} транзакций — Deedmap',
        'title_rent':  'Аренда в {name}{period_title}: {n} контрактов — Deedmap',
        ...
        'list_title_suffix': '{n} записей — Deedmap',
    ...
    'en': {
        ...
        'title_sales': 'Property transactions in {name}{period_title}: {n} deals — Deedmap',
        'title_rent':  'Rentals in {name}{period_title}: {n} contracts — Deedmap',
        ...
        'list_title_suffix': '{n} entries — Deedmap',
    ...
    'ar': {
        ...
        'title_sales': 'صفقات في {name}{period_title}: {n} معاملة — Deedmap',
        'title_rent':  'إيجارات في {name}{period_title}: {n} عقدًا — Deedmap',
        ...
        'list_title_suffix': '{n} سجل — Deedmap',
    ...
    'hi': {
        ...
        'title_sales': '{name} में सौदे{period_title}: {n} लेनदेन — Deedmap',
        'title_rent':  '{name} में किराया{period_title}: {n} अनुबंध — Deedmap',
        ...
        'list_title_suffix': '{n} प्रविष्टियां — Deedmap',
    ...
    'zh': {
        ...
        'title_sales': '{name} 交易{period_title}:{n} 笔 — Deedmap',
        'title_rent':  '{name} 租赁{period_title}:{n} 份合同 — Deedmap',
        ...
        'list_title_suffix': '{n} 条记录 — Deedmap',
