...
PAGES = {
    ...
    'investor': dict(
        ...
        title=dict(
            ru='Инвест-скор районов Дубая: где покупать под доход — DXBCompass',
            en='Dubai district investor score: where to buy for returns — DXBCompass',
            ar='مؤشر المستثمر لأحياء دبي: أين تشتري لتحقيق عائد — DXBCompass',
            hi='दुबई जिलों का निवेशक स्कोर: रिटर्न के लिए कहाँ खरीदें — DXBCompass',
            zh='迪拜各社区投资评分：在哪里买最划算 — DXBCompass',
        ),
        desc=dict(
            ru='Рейтинг районов Дубая для инвестиций в недвижимость: арендная '
               'доходность + перегрев цены, по типам квартир (студия, 1–4+ спальни). '
               'Формула проверена бэктестом на данных DLD 2014–2024.',
            en='Dubai district ranking for property investment: rental yield + price '
               'overheating, by apartment type (studio, 1–4+ BR). Formula backtested '
               'on 2014–2024 DLD data.',
            ar='تصنيف أحياء دبي للاستثمار العقاري: عائد الإيجار + فورة الأسعار، حسب '
               'نوع الشقة (استوديو، 1–4+ غرف). الصيغة مُختبرة على بيانات DLD 2014–2024.',
            hi='संपत्ति निवेश के लिए दुबई जिलों की रैंकिंग: किराया यील्ड + मूल्य ओवरहीटिंग, '
               'अपार्टमेंट प्रकार (स्टूडियो, 1–4+ BR) के अनुसार। फ़ॉर्मूला 2014–2024 DLD '
               'डेटा पर बैकटेस्ट किया गया।',
            zh='迪拜各社区房产投资排名：租金收益率 + 价格过热度，按户型（开间、1–4+ 卧）细分。'
        ...
        dataset_name=dict(
            ru='Инвест-скор районов Дубая',
            en='Dubai district investor score',
            ar='مؤشر المستثمر لأحياء دبي',
            hi='दुबई जिला निवेशक स्कोर',
            zh='迪拜社区投资评分',
        ),
    ),
    'payback': dict(
