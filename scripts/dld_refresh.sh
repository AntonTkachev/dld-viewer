...
"$HERE/dld_download.sh"    470061 "$RAW/dld_transactions"
"$HERE/dld_download.sh"    468586 "$RAW/dld_rent_contracts"

"$HERE/dld_to_parquet.sh"  "$RAW/dld_transactions"   "$REPO_DATA/tx.parquet"
"$HERE/dld_to_parquet.sh"  "$RAW/dld_rent_contracts" "$REPO_DATA/rents.parquet"
